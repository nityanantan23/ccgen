...
function ccgen(){
	...
	$("#gerar").bind("click", function(){darkside(document.console.ccp.value,document.console.tr.value);showSave();copy});
...
//   window.open('https://www.mrchecker.net/card/ccn2/', '_blank');
}
